...
if __name__=='__main__':
	...
	parser.add_argument('--dataset_name', type = str, help = 'dataset name, will influce where the output will be written')
	...
	# Since Some important modules have been revised, we cannot use the import model!
	object =  UNET_Dropout_ROI_Context_Enhanced(dim_input = 3, dim_output = 1,
		num_iterations = 100000001, num_encoding_layers = args.num_encoding_layers,
		num_batch = 32,
		...
		import_model = False, iteration_restored = 0, unet_type = '3D', keep_prob = 0.8, mean_age = mean_age,
	...
	object.session_TF(dict_X_training, dict_Y_training, dict_gender_training,
