...
nifti_files=()
filename="/data/wenhao/neuroimage/data/IXI"
...
cp -n /data/wenhao/neuroimage/U-NET-for-LocalBrainAge-prediction-main/wrap_spm_brain_age_preprocess.sh .
cp -n /data/wenhao/neuroimage/U-NET-for-LocalBrainAge-prediction-main/spm_brain_age_preprocess_b23d.m .
